...
class DiscordGSM():
    ...
    def get_embed(self, server):
        ...
        embed.set_footer(text=f'#MIP | Servers | Última actualización: ' + datetime.now().strftime('%a, %Y-%m-%d %I:%M:%S%p'), icon_url='https://github.com/DiscordGSM/DiscordGSM/raw/master/images/discordgsm.png')
